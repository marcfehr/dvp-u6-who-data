...
print('Chile, Germany, Mexico, USA, Zimbabwe')
...
plt.xlabel('Country', fontsize=10)
plt.ylabel('GDP', fontsize=10)
plt.title('Average Life Expectation in Years')
plt.savefig('LifeExpectationAverage.png')
plt.show()
...
print('No, not at all! The LEABY is very similar compared to the differnce at GDP.')
...
sns.violinplot(x='Country', y='LEABY', data=df, palette="Set2", split=True)
...
print('Zimbabwe does not really move on the X axis, which is not very surprising. Mexico also stays in the same spot on the X axis, but also on the Y axis. It is basicall not moving. The US and China move incredibly fast on the X axis while having a strong, stable Y axis value.')
...
print('The USA and China definitely have the highest GDP out of all the countries listed.')
...
print('Germany is rather high. Zimbabwe is very low.')
...
# # The blog post
# This final Codecademy course exercise is published as a Dropbox paper and can be found here:
# https://paper.dropbox.com/doc/Who-lives-longest-and-why-having-more-mone-doesnt-necessarily-influence-that.--APtOCKrwIZGHq4jXzCFgIE3bAQ-Q1rDc9vZGb42hXLabfF20
